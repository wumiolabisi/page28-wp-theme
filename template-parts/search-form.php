...
<form class="p28-search-form" action="<?php echo admin_url('admin-ajax.php'); ?>" method="post">
        ...
        <?php if (!($taxonomy->name == "realisation") && !($taxonomy->name == "production") && !($taxonomy->name == "scenario")) : ?>
            <div class="p28-search-form-item">
                ...
                <?php else : ?>
                    ...
                    <select class="p28-select" name="<?php echo $taxonomy->name; ?>" id="<?php echo $taxonomy->name; ?>-select">
    ...
    <div class="p28-search-form-item" id="p28-submit-form">
        ...
        <button class="p28-btn-primary">
            FILTRER
        </button>
    </div>

    <div class="p28-search-form-item" id="p28-reload">
        <span class="p28-svginteract" title="Réinitialiser les filtres" onclick="window.location.reload();">
            <svg class="width-20 p28-svg-dark" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
