        ...
        <ul>
            <li>
                <a href="<?php echo home_url('/'); ?>" alt="Aller à la page d'accueil" title="Aller à la page d'accueil">
                    <div>
                        <img src="<?php echo get_template_directory_uri(); ?>/img/home.png" alt="Icône en forme de maison" class="width-50">
                    </div>
                    <span>Accueil</span>
                </a>
            </li>
            <li>
                <a href="<?php echo home_url('/'); ?>" alt="Aller au catalogue" title="Aller au catalogue">
                    <div>
                        <img src="<?php echo get_template_directory_uri(); ?>/img/search.png" alt="Icône qui représente une loupe" class="width-50">
                    </div>
                    <span>Recherche</span>
                </a>
            </li>
            ...
            <li>
                <a href="<?php echo home_url('/'); ?>" alt="A propos de Page 28" title="A propos de Page 28">
                    <div>
                        <img src="<?php echo get_template_directory_uri(); ?>/img/info.png" alt="Icône d'information" class="width-50">
                    </div>
                    <span>A propos</span>
                </a>
            </li>
