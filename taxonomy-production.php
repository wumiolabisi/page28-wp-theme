...
/* Afficher la page d'archive de la taxonomie PROD :
*/
...
<div class="p28-container">
    ...
    <h2 class=" p28-txtcenter">Découvrez toutes les &oelig;uvres produites ou co-produites par <?php echo get_queried_object()->name ?></h2>
