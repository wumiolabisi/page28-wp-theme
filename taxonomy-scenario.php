...
/* Afficher la page d'archive de la taxonomie SCENAR :
*/
...
<div class="p28-container">
    ...
    <h2 class=" p28-txtcenter">Découvrez toutes les &oelig;uvres scénarisées ou co-scénarisées par <?php echo get_queried_object()->name ?></h2>
